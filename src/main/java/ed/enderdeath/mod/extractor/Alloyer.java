...
public class Alloyer extends Block implements ITileEntityProvider
{
    ...
    public static String[] blockTexture = new String[] {/* 0 */Enderdeath.TEXTURE_NAME + "machine_side", /* 1 */Enderdeath.TEXTURE_NAME + "machine_side", /* 2 */Enderdeath.TEXTURE_NAME + "machine_top", /* 3 */Enderdeath.TEXTURE_NAME + "machine_bottom", /* 4 */Enderdeath.TEXTURE_NAME + "machine_top"};
