...
public class EnchantForge
{
    ...
    public void particule()
    {
        for(k = 0; k < 2; ++k)
        {
            ((World)this.worldObj).spawnParticle("fire", this.posX + (this.rand.nextDouble() - 0.5D) * (double)this.width, this.posY + this.rand.nextDouble() * (double)this.height - 0.25D, this.posZ + (this.rand.nextDouble() - 0.5D) * (double)this.width, (this.rand.nextDouble() - 0.5D) * 2.0D, -this.rand.nextDouble(), (this.rand.nextDouble() - 0.5D) * 2.0D);
        }
    }
    ...
    public void onHurtMob(LivingHurtEvent e)
    {
        if(e.entity instanceof KingHeal)
        {
            ...
            skeletona.setPosition(e.entity.posX - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posY - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posZ - 5 + e.entity.worldObj.rand.nextInt(10));
            Goblin skeletonas = new Goblin(e.entity.worldObj);
            skeletonas.setPosition(e.entity.posX - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posY - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posZ - 5 + e.entity.worldObj.rand.nextInt(10));

            Goblin skeletonaq = new Goblin(e.entity.worldObj);
            skeletonaq.setPosition(e.entity.posX - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posY - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posZ - 5 + e.entity.worldObj.rand.nextInt(10));

            Goblin skeletoncxa = new Goblin(e.entity.worldObj);
            skeletoncxa.setPosition(e.entity.posX - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posY - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posZ - 5 + e.entity.worldObj.rand.nextInt(10));
            Goblin skeletonadsq = new Goblin(e.entity.worldObj);
            skeletonadsq.setPosition(e.entity.posX - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posY - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posZ - 5 + e.entity.worldObj.rand.nextInt(10));
        ...
        if(e.entity instanceof EntityCreeperBoss)
        {
            ...
            skeletonq.setPosition(e.entity.posX - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posY - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posZ - 5 + e.entity.worldObj.rand.nextInt(10));
    ...
    public void onHurtMobGoblin(LivingHurtEvent e)
    {
        if(e.entity instanceof GoblinKing)
        {
            ...
            skeleton.setPosition(e.entity.posX - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posY - 5 + e.entity.worldObj.rand.nextInt(10), e.entity.posZ - 5 + e.entity.worldObj.rand.nextInt(10));
    ...
    public void onDrops(BlockEvent.HarvestDropsEvent event)
    {
        ...
        else if(event.block == Blocks.mob_spawner && event.harvester.getHeldItem().getItem() != null && event.harvester.getHeldItem().getItem() == Enderdeath.pickaxeSpawner)
        {
            event.drops.clear();
    ...
    public void onRenderPre(RenderGameOverlayEvent.Pre event)
    {
        if(event.type == RenderGameOverlayEvent.ElementType.DEBUG)
        {
            ...
            this.drawString(Minecraft.getMinecraft().fontRenderer, mc.theWorld.getBiomeGenForCoords(MathHelper.floor_double(mc.thePlayer.posX), MathHelper.floor_double(mc.thePlayer.posZ)).biomeName, 0, 65, 0xFF0000);
    ...
    public void onLivingDrops(LivingDropsEvent event)
    {
        if(event.entity instanceof EntityGiantZombie)
        {
            ...
            for(int i = 0; i < event.drops.size(); i++)
            {
                ...
                EntityItem newdrop = new EntityItem(event.entity.worldObj, event.entity.posX, event.entity.posY, event.entity.posZ, new ItemStack(Enderdeath.rubis, 16));
