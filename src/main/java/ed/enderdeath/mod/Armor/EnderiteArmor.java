...
public class EnderiteArmor extends ItemArmor
{
	...
	AttributeModifier maxHealth = new AttributeModifier("ArmorHealth0", 1.5D, 0);
	 ...
	 if(input.getItem() ==  this && repair.getItem() == enderdeath.hulmini)
	 {
	   ...
	   public boolean hasEffect(ItemStack stack, int pass)
		...
		private void playerTick(EntityPlayer player) {
			...
			if (Keyboard.isKeyDown(Keyboard.KEY_SPACE) && (player.jumpMovementFactor == 0.02F || player.isAirBorne)
					&& player.motionY < 0.07 && !hasJumped)
