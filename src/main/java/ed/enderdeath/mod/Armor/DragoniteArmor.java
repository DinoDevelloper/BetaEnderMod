...
public class DragoniteArmor extends ItemArmor {
	...
	AttributeModifier maxHealth = new AttributeModifier("ArmorHealth0", 3.5D, 0);


	public DragoniteArmor(ArmorMaterial p_i45325_1_, int p_i45325_3_) {
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
		if (this.armorType == 0 && world.getBlockLightValue(MathHelper.floor_double(player.posX),
				MathHelper.floor_double(player.posY), MathHelper.floor_double(player.posZ)) < 7) {
