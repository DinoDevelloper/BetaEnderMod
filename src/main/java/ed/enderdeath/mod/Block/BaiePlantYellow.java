...
public class BaiePlantYellow extends Block implements IPlantable
{
...
public BaiePlantYellow(Item item)
{
    super(Material.leaves);
    setTickRandomly(true);
    setHardness(0.0F);
    setBlockName("BaiePlantYellow");
    ...
    textureNames[0] = "Yellow1";
    textureNames[1] = "Yellow2";
}
        ...
        float par8, float par9)
{
    ...
    if(meta >= 1)
    {
        ...
        {
            world.setBlock(x, y, z, this, 0, 3);
            world.spawnEntityInWorld(new EntityItem(world, x, y, z, new ItemStack(enderdeath.BaieYellow)));
            return true;
        }
    } else
    {
...
{
    return enderdeath.BaiePlantGreenItem;
}
...
public void registerBlockIcons(IIconRegister icon)
{
    ...
    for(int i = 0; i < fastIcons.length; i++)
    {
        if(textureNames[i] != "")
        {
            ...
            this.icon = icon.registerIcon(enderdeath.MODID + ":Yellow2Fast");
        }
    }
