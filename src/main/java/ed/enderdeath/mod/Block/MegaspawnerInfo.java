...
public abstract class MegaspawnerInfo
{
	/*J'ai commenté juste les variable pour changé les capacité du spawner*/
	
    /*Le délai du spawn*/
    public int spawnDelay = 10;
    /*l'entity par défaut*/
    private String entityTypeName = "Skeleton";
    
   
    private List potentialEntitySpawns;
    private MegaspawnerInfo.WeightedRandomMinecart randomEntity;
    ...
    /**/
    private int maxNearbyEntities = 17;
    /**/
    private int activatingRangeFromPlayer = 50;
    /**/
    ...
    public void updateSpawner()
    {
        if (this.isActivated())
        {
            ...
            if (this.getSpawnerWorld().isRemote)
            {
                ...
                this.getSpawnerWorld().spawnParticle("lava", d0, d1, d2, 0.0D, 0.0D, 0.0D);
    ...
    public Entity func_98265_a(Entity p_98265_1_)
    {
        if (this.getRandomEntity() != null)
        {
            ...
            for (Entity entity1 = p_98265_1_; nbttagcompound.hasKey("lava", 10); nbttagcompound = nbttagcompound2)
            {
                nbttagcompound2 = nbttagcompound.getCompoundTag("lava");
    ...
    private void resetTimer()
    {
        ...
        {
            this.setRandomEntity((MegaspawnerInfo.WeightedRandomMinecart)WeightedRandom.getRandomItem(this.getSpawnerWorld().rand, this.potentialEntitySpawns));
        }
    ...
    public void readFromNBT(NBTTagCompound p_98270_1_)
    {
        ...
        if (p_98270_1_.hasKey("SpawnPotentials", 9))
        {
            ...
            {
                this.potentialEntitySpawns.add(new MegaspawnerInfo.WeightedRandomMinecart(nbttaglist.getCompoundTagAt(i)));
            }
        }
        else
        {
        ...
        {
            this.setRandomEntity(new MegaspawnerInfo.WeightedRandomMinecart(p_98270_1_.getCompoundTag("SpawnData"), this.entityTypeName));
        }
        else
        {
            this.setRandomEntity((MegaspawnerInfo.WeightedRandomMinecart)null);
        }
    ...
    public void writeToNBT(NBTTagCompound p_98280_1_)
    {
        ...
        if (this.getRandomEntity() != null || this.potentialEntitySpawns != null && this.potentialEntitySpawns.size() > 0)
        {
            ...
            if (this.potentialEntitySpawns != null && this.potentialEntitySpawns.size() > 0)
            {
                ...
                while (iterator.hasNext())
                {
                    MegaspawnerInfo.WeightedRandomMinecart weightedrandomminecart = (MegaspawnerInfo.WeightedRandomMinecart)iterator.next();
    ...
    public MegaspawnerInfo.WeightedRandomMinecart getRandomEntity()
    {
        return this.randomEntity;
    }

    public void setRandomEntity(MegaspawnerInfo.WeightedRandomMinecart p_98277_1_)
    {
