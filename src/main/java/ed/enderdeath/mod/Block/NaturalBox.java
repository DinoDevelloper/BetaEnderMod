...
public class NaturalBox extends Block {
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
		...
		if (p_149727_5_.getHeldItem() != null && p_149727_5_.getHeldItem().getItem() == enderdeath.NaturalKey) {
			...
			ItemStack[] prices = new ItemStack[] { new ItemStack(enderdeath.SaphirBoot),
					new ItemStack(enderdeath.SaphirHelmet), new ItemStack(enderdeath.SaphirChestplate),
					new ItemStack(enderdeath.SaphirChestplate), new ItemStack(enderdeath.SwordSaphir),
					new ItemStack(enderdeath.SwordSaphir),
					 new ItemStack(enderdeath.SwordSaphir),
				new ItemStack(enderdeath.SwordSaphir),
					new ItemStack(enderdeath.BaieCake, 3),
					new ItemStack(enderdeath.BaieOfChocolate, 1), new ItemStack(enderdeath.SaphirSwordA),
					 new ItemStack(enderdeath.GoldenCroquette,2),
					 new ItemStack(enderdeath.SaphirCroquette,1),
					 new ItemStack(enderdeath.RubisCroquette,1),new ItemStack(enderdeath.SitckJolo, 1),
					new ItemStack(enderdeath.BaieOrange, 5), new ItemStack(enderdeath.DeathKey, 1), 
					new ItemStack(enderdeath.NaturalKey, 2),new ItemStack(enderdeath.Rubis, 32),
					new ItemStack(enderdeath.BaieHeal, 1), new ItemStack(Blocks.obsidian, 45)};
			{
