...
public class BaiePlantGreen extends Block implements IPlantable
{
...
public BaiePlantGreen(Item item)
{
    super(Material.leaves);
    setTickRandomly(true);
    setHardness(0.0F);
    setBlockName("BaiePlantGreen");
    ...
    textureNames[0] = "Green1";
    textureNames[1] = "Green2";
}
        ...
        float par8, float par9)
{
    ...
    if(meta >= 1)
    {
        ...
        {
            world.setBlock(x, y, z, this, 0, 3);
            world.spawnEntityInWorld(new EntityItem(world, x, y, z, new ItemStack(enderdeath.BaieGreen)));
            return true;
        }
    } else
    {
...
public void registerBlockIcons(IIconRegister icon)
{
    ...
    for(int i = 0; i < fastIcons.length; i++)
    {
        if(textureNames[i] != "")
        {
            ...
            this.icon = icon.registerIcon(enderdeath.MODID + ":Green2Fast");
        }
    }
