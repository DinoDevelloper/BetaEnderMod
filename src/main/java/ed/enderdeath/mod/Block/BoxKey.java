...
public class BoxKey extends Block {
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
		...
		if (p_149727_5_.getHeldItem() != null && p_149727_5_.getHeldItem().getItem() == enderdeath.DeathKey) {
			...
			ItemStack[] prices = new ItemStack[] { new ItemStack(enderdeath.RoyaliteBlock),
					new ItemStack(enderdeath.RoyaliteHelmet), new ItemStack(enderdeath.RoyaliteChestplate),
					new ItemStack(enderdeath.RoyaliteLeggings), new ItemStack(enderdeath.SwordRoyalite),
					new ItemStack(enderdeath.SwordSaphir),
					 new ItemStack(enderdeath.SwordRoyalite),
					new ItemStack(enderdeath.NuggetEnderite, 1), new ItemStack(enderdeath.SwordDarkanite),
					new ItemStack(enderdeath.BaieCake, 3),
					new ItemStack(enderdeath.BaieOfChocolate, 3), new ItemStack(enderdeath.SwordDarkanite),
					new ItemStack(enderdeath.BaieOfChocolate, 5), new ItemStack(enderdeath.DeathKey, 2), 
					new ItemStack(enderdeath.NaturalKey, 3),new ItemStack(enderdeath.UltimeKey, 1),
					new ItemStack(enderdeath.BaieOfChocolate, 1), new ItemStack(Blocks.obsidian, 100),new ItemStack(enderdeath.SkinFire, 1),new ItemStack(enderdeath.StickSpeed, 1),
