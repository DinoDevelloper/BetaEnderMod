...
{
    private IIcon top;
    private static final Item[] dropA = new Item[] {Items.glowstone_dust, Items.sugar, Items.redstone, Items.spider_eye, Items.glass_bottle, Items.gunpowder, Items.stick, Items.stick};
    private static final Item[] dropB = new Item[] {Items.apple, Items.arrow, Items.blaze_rod, Items.bow, Items.chest_minecart, Items.glass_bottle, Items.minecart, Items.record_far};
