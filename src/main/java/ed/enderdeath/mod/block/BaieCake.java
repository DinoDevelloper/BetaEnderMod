...
public class BaieCake extends Block
{
    ...
    public BaieCake()
    {
        ...
        this.setBlockName("BaieCake");
        this.setBlockTextureName(Enderdeath.MODID + ":BaieCake");
    ...
    private void func_150036_b(World p_150036_1_, int p_150036_2_, int p_150036_3_, int p_150036_4_, EntityPlayer p_150036_5_)
    {
        ...
        {
            p_150036_5_.getFoodStats().addStats(4, 0.1F);
            ...
            {
                p_150036_1_.setBlockMetadataWithNotify(p_150036_2_, p_150036_3_, p_150036_4_, l, 3);
            }
            if(onBlockActivated(p_150036_1_, p_150036_2_, p_150036_3_, p_150036_4_, p_150036_5_, 3, blockHardness, blockHardness, blockHardness))
            {
                p_150036_5_.addPotionEffect(new PotionEffect(Potion.nightVision.id, 5000, 0));
                p_150036_5_.addPotionEffect(new PotionEffect(Potion.invisibility.id, 5000, 0));
                p_150036_5_.addPotionEffect(new PotionEffect(Potion.fireResistance.id, 5000, 0));

                p_150036_5_.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 5000, 1));
                p_150036_5_.addPotionEffect(new PotionEffect(Potion.regeneration.id, 5000, 0));
