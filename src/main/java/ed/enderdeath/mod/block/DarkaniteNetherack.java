...
public class DarkaniteNetherack extends Block
{

    public DarkaniteNetherack()
    {
        super(Material.rock);
        setCreativeTab(CreativeTabs.tabBlock);
        setBlockName("DarkaniteNetherack");
        setBlockTextureName(Enderdeath.MODID + ":DarkaniteNetherack");
        setHardness(5.0F);
        setResistance(5.0F);
    ...
    {
        return Enderdeath.nuggetDarkanite;
    }
    ...
    public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_)
    {
        if(this.getItemDropped(p_149690_5_, rand, p_149690_7_) != Item.getItemFromBlock(this))
        {
            ...
            if(this == Enderdeath.darkaniteNetherack)
            {
