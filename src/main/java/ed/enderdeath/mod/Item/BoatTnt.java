...
public class BoatTnt extends Item {
	public BoatTnt() {
		this.maxStackSize = 1;
		this.setCreativeTab(CreativeTabs.tabTransport);
		this.setTextureName(enderdeath.MODID + ":BoatTnt");
		this.setUnlocalizedName("BoatTnt");
	}
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
		...
		if (movingobjectposition == null) {
			...
			boolean flag = false;
			float f9 = 1.0F;
			List list = p_77659_2_.getEntitiesWithinAABBExcludingEntity(p_77659_3_,
					p_77659_3_.boundingBox.addCoord(vec32.xCoord * d3, vec32.yCoord * d3, vec32.zCoord * d3)
			...
			if (flag) {
				...
				if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
					...
					EntityBoatTnT entityboat = new EntityBoatTnT(p_77659_2_, (double) ((float) i + 0.5F),
