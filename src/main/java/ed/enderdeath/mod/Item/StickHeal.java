...
public class StickHeal extends Item {
	public StickHeal()
	{
	  this.maxStackSize = 1;
      this.setMaxDamage(35);
      this.setCreativeTab(CreativeTabs.tabTools);
      this.setTextureName(enderdeath.MODID + ":StickHeal");
      this.setUnlocalizedName("StickHeal");
	}
	@Override
	...
	player.addPotionEffect(new PotionEffect(Potion.heal.id, 3, 5));
