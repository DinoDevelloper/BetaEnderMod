...
{
    Enchantment currentEnchantment = Enchantment.fortune;// Je ne mets pas de tableau car je pense que ton item aura uniquement qu'un seul enchantement � la fois. Car tu ne vas pas superposer les
                                                         // textures, sinon dis moi je corrige
    private IIcon icon1;
    private IIcon icon2;
    ...
    public IIcon getIconIndex(ItemStack stack)
    {
        if(currentEnchantment != null)
        {
            ...
            // Je t'ai ajout� un swtich pour tes connaissances personnelles, c'est toujours mieux de s'en servir. Apr�s tu peux connaitre les ID en regardant toutes les d�claration d'enchantement dans
            // la classse Enchantment. Regarde le premier argument de chaque instance, c'est l'id =)
            switch(id)
            {
