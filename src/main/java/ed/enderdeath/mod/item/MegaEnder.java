...

    {
...

        {
            ...
            if(p_77659_2_.isRemote)
                ...
                p_77659_3_.addChatComponentMessage(new ChatComponentTranslation("Tu dois attendre avant de relanc� une enderpearl"));// On indique au joueur via ce message si le timer n'est pas encore
                                                                                                                                     // la limite
        }
