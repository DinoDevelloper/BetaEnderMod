...
public class EntityBoatTnT extends Entity
{
    ...
    public EntityBoatTnT(World p_i1704_1_)
    {
        super(p_i1704_1_);
    ...
    public EntityBoatTnT(World p_i1705_1_, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(p_i1705_1_);
        ...
        else
        {
            ...
            if (this.isCollidedHorizontally && d10 > 0.2D)
            {
                if (!this.worldObj.isRemote && !this.isDead)
                {
                    ...
                    for (l = 0; l < 3; ++l)
                    {
                        this.func_145778_a(Item.getItemFromBlock(Blocks.tnt), 1, 0.0F);
                    }
