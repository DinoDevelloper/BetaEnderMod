...
public class Familiar extends EntityTameable implements IMob, IBossDisplayData {
	...
	public boolean attackEntityAsMob(Entity p_70652_1_) {
		...
		if (this.lvl == 0) {
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.poison.id, 1000, 0));
		}
		...
		if (this.lvl > 10) {
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.poison.id, 1000, 0));
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 2000, 0));
		}
		if (this.lvl > 40) {
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.weakness.id, 2000, 1));
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.wither.id, 2000, 1));
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 2000, 1));
		...
		if (this.lvl > 99) {
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.wither.id, 2000, 3));
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 2000, 3));
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.hunger.id, 2000, 3));
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.confusion.id, 500, 3));
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.blindness.id, 1000, 3));
			((net.minecraft.entity.EntityLivingBase) p_70652_1_)
					.addPotionEffect(new PotionEffect(Potion.digSlowdown.id, 2000, 3));
			this.motionY = 2.0F;
			((net.minecraft.entity.EntityLivingBase) p_70652_1_).setFire(10000);
	...
	public void onParticuleFire() {
		for (k = 0; k < 2; ++k) {
			this.worldObj.spawnParticle("fire", this.posX + (this.rand.nextDouble() - 0.5D) * (double) this.width,
					this.posY + this.rand.nextDouble() * (double) this.height - 0.25D,
					this.posZ + (this.rand.nextDouble() - 0.5D) * (double) this.width,
					(this.rand.nextDouble() - 0.5D) * 2.0D, -this.rand.nextDouble(),
					(this.rand.nextDouble() - 0.5D) * 2.0D);
	...
	public boolean isBreedingItem(ItemStack p_70877_1_) {
		return p_70877_1_ == null ? false
				: (!(p_70877_1_.getItem() instanceof Baie) ? false
						: ((Baie) p_70877_1_.getItem()).isFamiliarFavoriteMeat());
	}
	...
	public boolean canMateWith(EntityAnimal p_70878_1_) {
		if (p_70878_1_ == this) {
			...
			return !familiar.isTamed() ? false
					: (familiar.isSitting() ? false : this.isInLove() && familiar.isInLove());
		}
	}
