...
public class RenderFamiliar extends RenderLiving
{
    ...
    public final ResourceLocation textureSkin = new ResourceLocation(Enderdeath.MODID, "textures/entity/Robber.png");
    public final ResourceLocation texture = new ResourceLocation(Enderdeath.MODID, "textures/entity/Familiar.png");
